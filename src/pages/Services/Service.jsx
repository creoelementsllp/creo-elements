...
export const Service = () => {
    const { serviceSlug } = useParams(); // Get the service slug from the route
    ...
    return (
        ...
        <div className="service-page">
            ...
            <div className="service-header z-2">
                ...
                {isMobile ? <h1><WavyText fontSize='2.5rem'>{service.mobilename}</WavyText></h1> : <h1><WavyText fontSize='6rem'>{service.name}</WavyText></h1>}
            ...
            {service.extraComponent && <div className="extra-component">{service.extraComponent}</div>}
