    ...
    <div className="partners-container full-width">
      <div className="partners-container-inner">
        <div className="partner-eyebrow">
          <span className="partner-eyebrow-dot" />
          Integration Network
        </div>
        <h2 className="partner-header">Affiliates &amp; Partners</h2>
        <p className="partner-subheader">
          The tools and platforms we build on top of — trusted by our team and
          wired into every project we ship.
        </p>
        <div className="partner-circuit">
          <span className="partner-circuit-dot" />
        </div>
        <div className="partner-body">
          {partnersData.map((partner, index) => (
            <div
